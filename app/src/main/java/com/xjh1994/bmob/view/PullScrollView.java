...
public class PullScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray ta = context.obtainStyledAttributes(attrs, com.xjh1994.bmob.R.styleable.PullScrollView);


            if (ta != null) {
                mHeaderHeight = (int) ta.getDimension(com.xjh1994.bmob.R.styleable.PullScrollView_headerHeight, -1);
                mHeaderVisibleHeight = (int) ta.getDimension(com.xjh1994.bmob.R.styleable
